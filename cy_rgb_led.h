...
#define CY_RSLT_RGB_LED_CLK_FAIL         \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_BOARD_LIB_RGB_LED , 0))

/** Error code for RGB LED operation: PWM resource allocation failure */
#define CY_RSLT_RGB_LED_PWM_FAIL         \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_BOARD_LIB_RGB_LED , 1))

/** Error code for RGB LED operation: Low power callback function registration failure */
#define CY_RSLT_RGB_LED_LP_CB_REG_FAIL   \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_BOARD_LIB_RGB_LED , 2))

/** Error code for RGB LED operation: Low power callback function deregistration failure */
#define CY_RSLT_RGB_LED_LP_CB_DEREG_FAIL \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_BOARD_LIB_RGB_LED , 3))
...
#define CY_RGB_LED_COLOR_WHITE            (CY_RGB_LED_COLOR_RED | CY_RGB_LED_COLOR_GREEN | \
...
{
    return (((uint32_t)red) << CY_RGB_LED_RED_POS | ((uint32_t)green) <<
            CY_RGB_LED_GREEN_POS | ((uint32_t)blue) << CY_RGB_LED_BLUE_POS);
}
